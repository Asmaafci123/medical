                                    ...
                                    tabs: [
                                      ...
                                      Tab(
                                        ...
                                        child: Container(
                                          ...
                                          child: Align(
                                              alignment: Alignment.center,
                                              child: Text(AppStrings.response.tr(),
                                                  style: TextStyle(
                                                    fontSize: 18.sp,
                                                    fontWeight: FontWeight.w600,
                                                    fontFamily: "Certa Sans",
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              _cubit
                                                  .details
                                                  ?.medicalRequestDetails
                                                  ?.medicalRequest?.relation!= AppStrings.self.tr()?
                                              Row(
                                                children: [
                                                  SizedBox(
                                                    width: 100.w,
                                              ...
                                              _cubit
                                                  .details
                                                  ?.medicalRequestDetails
                                                  ?.medicalRequest?.requestType!=1?  Column(
                                                    children: [
                                                      Row(
                                                children: [
                                                      SizedBox(
                                          ...
                                          Padding(
                                            ...
                                            child: ChipsInput<DetailsOfMedical>(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                labelText:   AppStrings.medicalEntity.tr(),
                                                labelStyle:
                                  ...
                                  onTap: () async {
                                    if (_tabController.index == 0 &&
                                      ...
                                      showMessageDialog(
                                        context: context,
                                        isSucceeded: false,
                                        message: AppStrings.pleaseSelectMedicalEntity.tr(),
                                      );
                                    } else {
                                        ...
                                        if (_cubit.selectedMedicalEntity !=
                                          ...
                                          if (_cubit.selectedMedicalItems
                                            ...
                                            showMessageDialog(
                                              ...
                                              isSucceeded: false,
                                              message:
                                                  AppStrings.pleaseSelectMedicalItems.tr(),
                                            );
                                          }
                                        }
                                      } else {
