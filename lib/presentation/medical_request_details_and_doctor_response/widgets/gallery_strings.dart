...
class GalleryString extends StatefulWidget {
  final List<String> images;
  final int index;

  const GalleryString({Key? key, required this.images, this.index = 0})
      :
        super(key: key);

  @override
  _GalleryStringState createState() => _GalleryStringState();
}

class _GalleryStringState extends State<GalleryString> {
  late int index;
