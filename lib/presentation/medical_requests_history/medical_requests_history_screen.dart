                                                        ...
                                                        TextFormField(
                                                          ...
                                                          validator: (String? value) {
                                                            ...
                                                            print(_cubit
                                                                .requestIdFiltrationController);
                                                            print("1111111111111111111111111111111111111111111111111");
                                                            if (value!.isEmpty && _cubit.requestIdFiltrationController.text.toString().isEmpty) return AppStrings.required.tr();
                                                            return null;
                                                          },
                                                          decoration:
                                                              InputDecoration(
                                                    ...
                                                    child: GestureDetector(
                                                      onTap: () {
                                                        ...
                                                        if(_cubit.selectedRequestType<=0
                                                            && _cubit.selectedRequestStatus<=0
                                                            && _cubit.requestIdFiltrationController.text.isEmpty
                                                        &&_cubit.userNumberSearch.text.isEmpty
                                                        && _cubit.selectedRelative==null
                                                        && _cubit.fromText.text.isEmpty
                                                        && _cubit.toText.text.isEmpty)
                                                        {
                                                          Navigator.pop(context);
                                                        }
                                                        else
                                                          {
                                                            if( _filterKey.currentState!.validate())
                                                            {
                                                              Navigator.pop(context);
                                                              _cubit.filter();
                                                            }
