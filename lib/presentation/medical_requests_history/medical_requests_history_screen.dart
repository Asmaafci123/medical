    ...
    return BlocProvider<MyMedicalRequestsCubit>(
      ...
      child: BlocConsumer<MyMedicalRequestsCubit, MyMedicalRequestsState>(
        listener: (context, state) {
          ...
          if (state is GetFilteredMedicalRequestsSuccessState) {
        ...
        builder: (context, state) {
          ...
          final GlobalKey<FormState> _filterKey = GlobalKey<FormState>();
          return Scaffold(
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    controller: _cubit
                                        .searchInMyMedicalRequestsController,
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Wrap(
                                                      children: [
                                                        SelectionChip(
                                                            label: AppStrings.medications.tr(),
                                                            index: 1,
                                                    ...
                                                    TextField(
                                                      ...
                                                      decoration:
                                                          InputDecoration(
                                                        hintText: AppStrings.requestID.tr(),
                                                        isDense: true,
                                                        contentPadding:
                                                            EdgeInsets
                                                                .symmetric(
                                                              ...
                                                              DropdownButtonFormField<
                                                                  ...
                                                                  items: [
                                                                    ...
                                                                    ...userData!
                                                                        .relatives!
                                                                        .map((e) =>
                                                                            DropdownMenuItem<Relative>(
                                                                              child: Text(e.relativeName,
                                                                                  style: TextStyle(
                              ...
                              ? _cubit.myMedicalRequests.isNotEmpty
                                  ? Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              "${AppStrings.result.tr()} ( ${_cubit.myMedicalRequests.length} )",
                                              style: TextStyle(
                                          ...
                                          Text(
                                              AppStrings.yourMedicalRequests
                                                  .tr(),
                                              style: TextStyle(
                                                color: AppColors.greyDark,
                                                fontSize: 14.sp,
                                  ...
                                  ? _cubit.filteredMedicalRequest.isNotEmpty
                                      ? Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                  "${AppStrings.result.tr()} ( ${_cubit.filteredMedicalRequest.length})",
                                                  style: TextStyle(
                                                    color: AppColors.greyDark,
                                                    fontSize: 18.sp,
                                                    fontWeight: FontWeight.w200,
                                              ...
                                              Text(
                                                  "${AppStrings.medicalRequestsFor.tr()} ${_cubit.filteredMedicalRequest[0].employeeName}: ",
                                                  style: TextStyle(
                                                    color: AppColors.greyDark,
                                                    fontSize: 14.sp,
                                                    fontWeight: FontWeight.w200,
                                  ...
                                  ? Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(AppStrings.yourMedicalRequests
                                              .tr(),
                                              style: TextStyle(
                                                color: AppColors.greyDark,
                                                fontSize: 14.sp,
                                  ...
                                  ? _cubit.searchedResult.isNotEmpty
                                      ? Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                  "${AppStrings.result.tr()} ( ${_cubit.searchedResult.length})",
                                                  style: TextStyle(
                                                    color: AppColors.greyDark,
                                                    fontSize: 18.sp,
                                                    fontWeight: FontWeight.w200,
                                              ...
                                              Text(
                                                  "${AppStrings.medicalRequestsFor.tr()} ${_cubit.searchedResult[0].employeeName}: ",
                                                  style: TextStyle(
                                                    color: AppColors.greyDark,
                                                    fontSize: 14.sp,
                                                    fontWeight: FontWeight.w200,
